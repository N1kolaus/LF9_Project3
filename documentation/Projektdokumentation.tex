...
Nach dem Einrichten der Firewall wird aus dem grünen Netz mittels des IPFire-Web"-interfaces verschiedene Einstellungen der Firewall bearbeitet. Für die Verbindungen zwischen Admin-PC, \ac{DHCP}-\ac{DNS}-\ac{DB}-Server und Webserver sowie für die Erreichbarkeit des Webservers aus dem roten Netz werden vier verschiedene Regeln erstellt, die in \vref{fig:FirewallConfig} zu sehen sind.
